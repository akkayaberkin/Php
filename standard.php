...
<body style="padding:0px; margin:0px; background-color:#fff;font-family:arial,helvetica,sans-serif,verdana,'Open Sans'">
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:-60px;left:0px;width:1300px;height:500px;overflow:hidden;visibility:hidden;padding: -10px 0 0 0px;;">
        <!-- Loading Screen -->
